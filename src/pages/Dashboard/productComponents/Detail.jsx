                    ...
                    <div className="product">
                        ...
                        <div className="product-info">
                            ...
                            <div className="buttons">
                                ...
                                <span onClick={() => window.confirm(t('dashboard.detail.confirm')) && deleteProductHandle(product.owner.brandname, product.isbn_code)}>{t('dashboard.detail.buttons.delete')}</span>
                            </div>
                        </div>
                        <div className="features">
                            <h4>{t('dashboard.detail.videohosting.h4')}</h4>
                            {features.length > 0 ? features.map((feature, i) => {
                                return (
                                    <span key={i}><strong>{feature.label}:</strong> {feature.value}</span>
                                )
                            }) : <small style={{ display: "block", width: "100%", textAlign: "center", marginTop: "50px" }}>{t('dashboard.detail.no_features')}</small>}
                        </div>
                    </div>
                                    ...
                                    <div className="access">
                                        {video.access ? 
                                            <span>
                                                ...
                                                <small>{t('dashboard.detail.videohosting.access')}</small>
                                            </span>
                                         : <span>
                                                ...
                                                <small>{t('dashboard.detail.videohosting.no_access')}</small>
                                            </span>}
                                        <small></small>
